                ...
                <div class="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                this Agreement) refers to Wyreema Christians Inc, 85, ROSEVALE.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Service Provider</strong> means any natural or legal person who processes the
                                ...
                                analysing how the Service is used.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Wyreema Christians, accessible from <a
                                    href="https://wychrist.org.au/" rel="external nofollow noopener"
                                    target="_blank">https://wychrist.org.au</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        ...
                        <li><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in
                            which case we will require those affiliates to honour this Privacy Policy. Affiliates include
                    ...
                    <ul>
                        <li>By email: secretary.wyreema@wychrist.org.au</li>
                    </ul>
                </div>
            </div>';
